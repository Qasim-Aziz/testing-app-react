...
class PeakEqviReport extends React.Component {
  ...
  componentDidMount() {
    const {
      dispatch,
      peakequivalence: { ProgramId, SelectedPeakType },
    } = this.props
  ...
  onChange = e => {
    ...
    const {
      dispatch,
      peakequivalence: { SelectedPeakType },
    } = this.props
  ...
  render() {
    ...
    const { GraphData, componentsKey } = this.state
    ...
    console.log(ReportScoreList, 'rpltis')
                ...
                <Col sm={24}>
                  ...
                  >
                    ...
                    <Radio.Group
                      ...
                      defaultValue={SelectedPeakType ? SelectedPeakType : 'Basic'}
                    >
                    ...
                    <Row>
                      ...
                      <Col span={16} style={{ padding: 10 }}>
                        ...
                        >
                          ...
                          {GraphData.length === 0 && <Empty style={{ marginTop: '100px' }} />}
                        </div>
                      </Col>
                    </Row>
                  </div>

...
const AllTicketsData = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      minWidth: '100px',
      maxWidth: '150px',
      cell: row => <span>{row.node && row.node.subject}</span>,
    },
    {
      name: 'Description',
      sortable: true,
      minWidth: '200px',
      maxWidth: '250px',
      cell: row => <span>{row.node && row.node.description}</span>,
    },
    {
      name: 'Priority',
      sortable: true,
      maxWidth: '100px',
      minWidth: '100px',
      cell: row => <span>{row.node && row.node.priority && row.node.priority.priority}</span>,
    },
    {
      name: 'Service',
      sortable: true,
      maxWidth: '150px',
      minWidth: '100px',
      cell: row => <span>{row.node && row.node.service && row.node.service.service}</span>,
    },

    {
      ...
      maxWidth: '150px',
      minWidth: '100px',
      cell: row => <span>{row.node && row.node.assignTo && row.node.assignTo.team}</span>,
    },
    {
      name: 'Date',
      maxWidth: '250px',
      minWidth: '200px',
      cell: row => <span>{row.node && row.node.createdAt}</span>,
    },
    {
      name: 'Status',
      maxWidth: '150px',

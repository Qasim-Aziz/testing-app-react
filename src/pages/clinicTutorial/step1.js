      ...
      <div style={{ paddingHorizontal: 10 }}>
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 4, padding: 10, backgroundColor: '#f9f9f9', marginLeft: 5 }}>
            <div style={{ marginBottom: 5, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: '18px', fontWeight: '500', marginLeft: 10 }}>
                More Videos in <b>{selectedLibraryName}</b>
              </span>
              <Button type='primary' size='small' onClick={() => showDrawer()}>Add Video</Button>
            </div>


            <div style={{ height: 320, maxHeight: 319, overflowY: 'scroll' }} className='scrollClass'>
              {liberaryDetailsLoading && selectedLibrary !== prevSelectedLibrary && <h3>Loading...</h3>}
              {liberaryDetailsError && (
                <h4 style={{ color: 'red' }}>Failed to load library details</h4>
              )}

              {liberaryDetails && liberaryDetails.getLibraryDetails.videos.edges.map(({ node }) => (
                <div>
                  <Card
                    onClick={() => {
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                        <Button type='link' size='small' style={{ color: 'red', marginRight: 5 }}><DeleteOutlined /></Button>
                        <Button type='link' size='small' onClick={() => { console.log("--0-0-0-0-0"); setUpdateVideo(node); }}><EditOutlined /></Button>
                      </div>
                    </div>
                  </Card>
        ...
        <div className='scrollClass' style={{ marginTop: 10, padding: 10, display: 'flex', flexDirection: 'row', maxWidth: '100%', overflowX: 'scroll', }}>
          ...
          <button type='button' onClick={() => setNewMasterDrawer(true)} style={{ marginRight: 10, minWidth: 100, maxWidth: 100, backgroundColor: '#FFF', padding: 10, borderRadius: 10 }}>
